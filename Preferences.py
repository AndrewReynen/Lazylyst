...
def defaultPreferences(main):
    ...
    'defaultColorText':Pref(tag='defaultColorText',val=13158600,dataType=int,
    ...
    'defaultColorMapSta':Pref(tag='defaultColorMapSta',val=65280,dataType=int,
    ...
    'defaultColorMapPrevEve':Pref(tag='defaultColorMapPrevEve',val=16777215,dataType=int,
