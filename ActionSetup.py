...
class Ui_actionDialog(object):
    def setupUi(self, actionDialog):
        ...
        self.actShortInputLayout.addWidget(self.activeTimerCheck, 0, 4, 1, 1)
        ...
        self.actShortInputLayout.addWidget(self.actTriggerLabel, 1, 3, 1, 1)
        ...
        self.actShortInputLayout.addWidget(self.actIntervalLabel, 3, 3, 1, 1)
        ...
        self.actShortInputLayout.addWidget(self.actIntervalLineEdit, 3, 4, 1, 1)
        ...
        actionDialog.setTabOrder(self.actActiveRadio, self.activeTimerCheck)
        actionDialog.setTabOrder(self.activeTimerCheck, self.actTriggerLineEdit)
    ...
    def retranslateUi(self, actionDialog):
        ...
        self.activeTimerCheck.setText(_translate("actionDialog", "Uses Timer", None))
