...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.traceLayout.setSizeConstraint(QtGui.QLayout.SetDefaultConstraint)
        ...
        self.archiveDock.setMinimumSize(QtCore.QSize(366, 122))
        self.archiveDock.setMaximumSize(QtCore.QSize(524287, 524287))
