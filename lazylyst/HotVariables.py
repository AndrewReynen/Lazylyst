...
def initHotVar():
    ...
    'curMapSta':HotVar(tag='curMapSta',val='',dataType=str,returnable=False,
                       tip='Last double clicked station on the map widget'),
    'curMapPos':HotVar(tag='curMapPos',val=[0,0],dataType=list,returnable=False,
                       tip='Last double clicked position on the map widget'),
